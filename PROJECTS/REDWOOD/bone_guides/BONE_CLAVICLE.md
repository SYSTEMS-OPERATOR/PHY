# BONE_CLAVICLE — Clavicle (midline)

## Purpose

Fabrication guide for midline Clavicle as a REDWOOD reference.  
Auto-generated from project anthropometric and anatomical datasets.

## Finished target envelope

- Finished length: `140 mm` *(see: adult_female_21_28.json)*
- Finished width: `N/A mm`
- Finished thickness: `N/A mm`
- Target side: `midline`
- Bone class: `flat_bone`

## Biological reference (21-year-old female, avg)

- Biological length: `14.0 cm`
- Biological width: `1.2 cm`
- Biological thickness: `1.2 cm`
- Mass: `16 g`
- Density: `1850 kg/m³`
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_CLAVICLE_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_CLAVICLE_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

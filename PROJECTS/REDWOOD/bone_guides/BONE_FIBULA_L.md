# BONE_FIBULA_L — Fibula (l)

## Purpose

Fabrication guide for l Fibula as a REDWOOD reference.  
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_FIBULA_L_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_FIBULA_L_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

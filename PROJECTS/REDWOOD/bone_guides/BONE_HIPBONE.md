# BONE_HIPBONE — HipBone (midline)

## Purpose

Fabrication guide for midline HipBone as a REDWOOD reference.  
...
- Biological length: `23.0 cm`
- Biological width: `14.0 cm`
- Biological thickness: `5.0 cm`
- Mass: `120 g`
- Density: `1800 kg/m³`
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_HIPBONE_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_HIPBONE_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

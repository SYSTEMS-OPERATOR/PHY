# BONE_HUMERUS_L — Humerus (l)

## Purpose

Fabrication guide for l Humerus as a REDWOOD reference.  
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_HUMERUS_L_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_HUMERUS_L_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

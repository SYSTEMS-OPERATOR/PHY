# BONE_HUMERUS_R — Humerus (r)

## Purpose

Fabrication guide for r Humerus as a REDWOOD reference.  
Auto-generated from project anthropometric and anatomical datasets.

## Finished target envelope

- Finished length: `310 mm` *(see: adult_female_21_28.json)*
...
- Biological length: `31.0 cm`
- Biological width: `3.0 cm`
- Biological thickness: `3.0 cm`
- Mass: `100 g`
- Density: `1900 kg/m³`
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_HUMERUS_R_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_HUMERUS_R_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

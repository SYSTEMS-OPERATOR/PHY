# BONE_RADIUS_L — Radius (l)

## Purpose

Fabrication guide for l Radius as a REDWOOD reference.  
Auto-generated from project anthropometric and anatomical datasets.

## Finished target envelope

- Finished length: `240 mm` *(see: adult_female_21_28.json)*
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_RADIUS_L_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_RADIUS_L_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

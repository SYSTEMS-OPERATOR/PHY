# BONE_RADIUS_R — Radius (r)

## Purpose

Fabrication guide for r Radius as a REDWOOD reference.  
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_RADIUS_R_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_RADIUS_R_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

# BONE_TIBIA_R — Tibia (r)

## Purpose

Fabrication guide for r Tibia as a REDWOOD reference.  
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_TIBIA_R_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_TIBIA_R_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

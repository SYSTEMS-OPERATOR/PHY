...
Fabrication guide for l Ulna as a REDWOOD reference.  
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_ULNA_L_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_ULNA_L_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

...
Fabrication guide for r Ulna as a REDWOOD reference.  
Auto-generated from project anthropometric and anatomical datasets.

## Finished target envelope

- Finished length: `250 mm` *(see: adult_female_21_28.json)*
...
|----------------------------|-------------|----------|----------------------|----------------------------------|
| BONE_ULNA_R_HIP_BUSHING_PILOT   | 12 mm      | TBD      | proximal end         | Validate with parent module      |
| BONE_ULNA_R_KNEE_BUSHING_PILOT  | 12 mm      | TBD      | distal end           | Validate with distal module      |

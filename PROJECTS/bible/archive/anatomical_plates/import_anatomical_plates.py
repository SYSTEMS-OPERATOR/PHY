#!/usr/bin/env python3
"""Import anatomical plate images listed in plate_manifest.json.
...
MANIFEST_PATH = Path("PROJECTS/bible/archive/anatomical_plates/plate_manifest.json")
REPORT_PATH = Path("PROJECTS/bible/archive/anatomical_plates/import_report.json")
...
def download(url: str, dest: Path, overwrite: bool = False, timeout: int = 60) -> dict:
    ...
    request = Request(url, headers={"User-Agent": "PHY-Wooden-Armature-Bible-Importer/0.1"})

...
class CAPA:
    ...
    severity: str
    owner: str
    opened: datetime.datetime = field(default_factory=datetime.datetime.utcnow)
...
class QMSManager:
    ...
    def add_document(self, doc_path: str, signer: str) -> None:
        ...
        self.docs[doc_path] = ControlledDocument(path, version, signer, datetime.datetime.utcnow())
